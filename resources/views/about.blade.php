...
<div class="container py-5">
        ...
        <div class="row mb-4">
            ...
            <div class="col-12 mt-4">
                <p class="text-muted text-center fw-semibold lh-base">
                    Selamat datang di platform Sistem Informasi Geografis (SIG) Pemetaan Oleh-Oleh Khas Banyumas.Website
                    yang bertujuan untuk memudahkan wisatawan dalam menemukan dan mengakses informasi tentang oleh-oleh
                    makanan ringan khas Banyumas.
                </p>
                ...
                <p class="text-muted text-center fw-normal lh-base">
                    Website ini dikembangkan dengan tujuan untuk menyediakan sistem informasi geografis berbasis web yang
                    mendukung pencarian dan pemetaan toko oleh-oleh makanan ringan khas Banyumas, memberikan informasi
                    detail seperti lokasi, jenis oleh-oleh, harga, jam operasional, dan ulasan pelanggan, serta memudahkan
                    wisatawan dalam merencanakan kunjungan ke berbagai toko oleh-oleh dengan lebih efektif.
                </p>
                <p class="text-muted text-center fw-normal lh-base">
                    Selain itu, kami juga bertujuan untuk meningkatkan visibilitas toko oleh-oleh, mempromosikan
                    produk-produk lokal, mendorong pertumbuhan ekonomi lokal dan melestarikan budaya kuliner Banyumas.
                </p>
            </div>
        </div>
        ...
        <div class="row mt-5 mb-5">
            <div class="col-12 text-center">
                <img src="https://upload.wikimedia.org/wikipedia/commons/6/66/Banyumas_Regency.jpg" alt="Banyumas Sign"
