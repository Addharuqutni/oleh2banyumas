...
<div class="container py-5">
    <!-- Section Header: Gunakan format yang konsisten -->
    <div class="row mb-4">
    ...
    <!-- Main Content Format yang terstruktur -->
    <div class="row mb-5">
        <div class="col-lg-10 mx-auto">
            <div class="card-body">
                ...
                <!-- Tujuan Section: Format yang konsisten dengan sections lainnya -->
                <div class="content-section">
                    <h2 class="judul text-center mb-3">Tujuan Kami</h2>
                    <div class="row">
                        <div class="col-lg-12 mx-auto">
                            <div class="row g-4">
                                <!-- Card items dengan format yang konsisten -->
                                <div class="col-md-6">
