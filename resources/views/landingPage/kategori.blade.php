    ...
    <div class="container">
        ...
        <div class="row mt-4">
            <div class="col-12 text-center">
                <a href="/artikel" class="btn btn-outline-success rounded-pill px-4 py-2 d-inline-flex align-items-center justify-content-center">
                    <span class="me-2">Lihat Semua Oleh-oleh</span>
                </a>
            </div>
        </div>
    </div>
