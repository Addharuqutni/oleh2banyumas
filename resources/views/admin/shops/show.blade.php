...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="{{ route('admin.shops.edit', ['shop' => $shop]) }}" class="btn btn-primary me-2">
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                @if ($shop->latitude && $shop->longitude)
                                    ...
                                    console.log('Longitude:', lng); // Log longitude
                                ...
                                @else
                                    alert('Koordinat lokasi toko tidak tersedia.');
                                @endif
                            });
                        </script>
                    @endsection
