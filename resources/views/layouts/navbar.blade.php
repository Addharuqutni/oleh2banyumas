        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            <ul class="navbar-nav ms-auto mb-0 py-3 py-lg-0">
                ...
                <li class="nav-item text-center border-bottom border-light-subtle d-lg-none py-2">
                    <a class="nav-link px-3 fw-medium {{ Request::is('/') ? 'active text-success' : '' }}"
                        href="/">
                        <i class="bi bi-house-door{{ Request::is('/') ? '-fill' : '' }} me-2"></i>Home
                    </a>
                </li>
                <li class="nav-item text-center border-bottom border-light-subtle d-lg-none py-2">
                    <a class="nav-link px-3 fw-medium {{ Request::is('about') ? 'active text-success' : '' }}"
                        href="/about">
                        <i class="bi bi-info-circle{{ Request::is('about') ? '-fill' : '' }} me-2"></i>Tentang
                    </a>
                </li>
                <li class="nav-item text-center border-bottom border-light-subtle d-lg-none py-2">
                    <a class="nav-link px-3 fw-medium {{ Request::is('artikel*') ? 'active text-success' : '' }}"
                        href="/artikel">
...
<style>
    Add commentMore actions .navbar {
